...
@Component
public class MDFIR400_9 {

    public static final String REPORT_NAME = "MDFIR400.9";
    ...
    public MDFIR400_9(sheet400_9_Impl sheet400_9_impl, TableImpl table) {
        this.sheet400_9_impl = sheet400_9_impl;
        this.table = table;
    }
    ...
    public XmlHeader getHEADER() {
        ...
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            table.getTableDataByReportName("QDFIR400.9");
        }
    ...
    public Body getBODY() {
        sheet400_9_impl.fetchAllData();
        return new Body(sheet400_9_impl.getSheet400_9XmlList());
    }
    ...
    public void convertToXml(sheet400_9_Impl sheet400_9_impl, TableImpl table) throws JAXBException, IOException, ClassNotFoundException {
        ...
        String simpleName = "";
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            simpleName = "QDFIR400.9";
        }
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.MONTHLY) == 0) {
            simpleName = this.getClass().getSimpleName();
        }
        marshaller.marshal(new MDFIR400_9(sheet400_9_impl, table), Files.newOutputStream(Paths.get(simpleName + ".xml")));
    }}
