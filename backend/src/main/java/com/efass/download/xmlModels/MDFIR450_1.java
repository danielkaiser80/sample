...
public class MDFIR450_1 {
    ...
    public MDFIR450_1(sheet450_1_Impl sheet450_1_impl, TableImpl table) {
        this.sheet450_1_impl = sheet450_1_impl;
        this.table = table;
    }
    ...
    public Body getBODY() {
        sheet450_1_impl.fetchAllData();
        return new Body(sheet450_1_impl.getSheet450_1XmlList());
    }
    ...
    public void convertToXml(sheet450_1_Impl sheet450_1_impl, TableImpl table) throws JAXBException, IOException, ClassNotFoundException {
        ...
        marshaller.marshal(new MDFIR450_1(sheet450_1_impl, table), Files.newOutputStream(Paths.get(simpleName + ".xml")));
    }}
