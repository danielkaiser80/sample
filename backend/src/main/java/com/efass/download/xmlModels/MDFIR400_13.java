...
@Component
public class MDFIR400_13 {

    public static final String REPORT_NAME = "MDFIR400.13";
    ...
    public MDFIR400_13(sheet400_13_Impl sheet400_13_impl, TableImpl table) {
        this.sheet400_13_impl = sheet400_13_impl;
        this.table = table;
    }
    ...
    public XmlHeader getHEADER() {
        ...
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            table.getTableDataByReportName("QDFIR400.13");
        }
    ...
    public Body getBODY() {
        sheet400_13_impl.fetchAllData();
        return new Body(sheet400_13_impl.getSheet400_13XmlList());
    }
    ...
    public void convertToXml(sheet400_13_Impl sheet400_13_impl, TableImpl table) throws JAXBException, IOException, ClassNotFoundException {
        ...
        marshaller.marshal(new MDFIR400_13(sheet400_13_impl, table), Files.newOutputStream(Paths.get(simpleName + ".xml")));
    }}
