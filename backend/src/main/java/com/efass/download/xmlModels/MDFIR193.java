...
public class MDFIR193 {
    ...
    public MDFIR193(sheet193_Impl sheet193_impl, TableImpl table) {
        this.sheet193_impl = sheet193_impl;
        this.table = table;
    }
    ...
    public XmlHeader getHEADER() {
        ...
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            table.getTableDataByReportName("QDFIR193");
        }
    ...
    public Body getBODY() {
        sheet193_impl.fetchAllData();
        return new Body(sheet193_impl.getSheet193XmlList());
    }
    ...
    public void convertToXml(sheet193_Impl sheet193_impl, TableImpl table) throws JAXBException, IOException, ClassNotFoundException {
        ...
        marshaller.marshal(new MDFIR193(sheet193_impl, table), Files.newOutputStream(Paths.get(simpleName + ".xml")));
    }}
