...
public class MDFIR1650 {
    ...
    public MDFIR1650(sheet1650_Impl sheet1650_impl, TableImpl table) {
        this.sheet1650_impl = sheet1650_impl;
        this.table = table;
    }
    ...
    public XmlHeader getHEADER() {
        ...
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            table.getTableDataByReportName("QDFIR1650");
        }
    ...
    public Body getBODY() {
        sheet1650_impl.fetchAllData();
        return new Body(sheet1650_impl.getSheet1650XmlList());
    }
    ...
    public void convertToXml(sheet1650_Impl sheet1650_impl, TableImpl table) throws JAXBException, IOException, ClassNotFoundException {
        ...
        String simpleName = "";
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            simpleName = "QDFIR1650";
        }
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.MONTHLY) == 0) {
            simpleName = this.getClass().getSimpleName();
        }
        marshaller.marshal(new MDFIR1650(sheet1650_impl, table), Files.newOutputStream(Paths.get(simpleName + ".xml")));
    }}
