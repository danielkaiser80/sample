...
@Component
public class MDFIR450_6 {

    public static final String REPORT_NAME = "MDFIR450.6";
    ...
    public MDFIR450_6(sheet450_6_Impl sheet450_6_impl, TableImpl table) {
        this.sheet450_6_impl = sheet450_6_impl;
        this.table = table;
    }
    ...
    public XmlHeader getHEADER() {
        ...
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            table.getTableDataByReportName("QDFIR450.6");
        }
    ...
    public Body getBODY() {
        sheet450_6_impl.fetchAllData();
        return new Body(sheet450_6_impl.getSheet450_6XmlList());
    }
    ...
    public void convertToXml(sheet450_6_Impl sheet450_6_impl, TableImpl table) throws JAXBException, IOException, ClassNotFoundException {
        ...
        String simpleName = "";
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            simpleName = "QDFIR450.6";
        }
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.MONTHLY) == 0) {
            simpleName = this.getClass().getSimpleName();
        }
        marshaller.marshal(new MDFIR450_6(sheet450_6_impl, table), Files.newOutputStream(Paths.get(simpleName + ".xml")));
    }}
