...
public class MDFIR201 {
    ...
    public MDFIR201(sheet201_Impl sheet201_impl, TableImpl table) {
        this.sheet201_impl = sheet201_impl;
        this.table = table;
    }
    ...
    public XmlHeader getHEADER() {
        ...
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            table.getTableDataByReportName("QDFIR201");
        }
    ...
    public Body getBODY() {
        sheet201_impl.fetchAllData();
        return new Body(sheet201_impl.getSheet201XmlList());
    }
    ...
    public void convertToXml(sheet201_Impl sheet201_impl, TableImpl table) throws JAXBException, IOException, ClassNotFoundException {
        ...
        marshaller.marshal(new MDFIR201(sheet201_impl, table), Files.newOutputStream(Paths.get(simpleName + ".xml")));
    }}
