...
@Component
public class MDFIR400_7 {

    public static final String REPORT_NAME = "MDFIR400.7";
    ...
    public MDFIR400_7(sheet400_7_Impl sheet400_7_impl, TableImpl table) {
        this.sheet400_7_impl = sheet400_7_impl;
        this.table = table;
    }
    ...
    public XmlHeader getHEADER() {
        ...
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            table.getTableDataByReportName("QDFIR400.7");
        }
    ...
    public Body getBODY() {
        sheet400_7_impl.fetchAllData();
        return new Body(sheet400_7_impl.getSheet400_7XmlList());
    }
    ...
    public void convertToXml(sheet400_7_Impl sheet400_7_impl, TableImpl table) throws JAXBException, IOException, ClassNotFoundException {
        ...
        String simpleName = "";
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            simpleName = "QDFIR400.7";
        }
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.MONTHLY) == 0) {
            simpleName = this.getClass().getSimpleName();
        }
        marshaller.marshal(new MDFIR400_7(sheet400_7_impl, table), Files.newOutputStream(Paths.get(simpleName + ".xml")));
    }}
