...
@Component
public class MDFIR450_2 {

    public static final String REPORT_NAME = "MDFIR450.2";
    ...
    public MDFIR450_2(sheet450_2_Impl sheet450_2_impl, TableImpl table) {
        this.sheet450_2_impl = sheet450_2_impl;
        this.table = table;
    }
    ...
    public XmlHeader getHEADER() {
        ...
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            table.getTableDataByReportName("QDFIR450.2");
        }
    ...
    public Body getBODY() {
        sheet450_2_impl.fetchAllData();
        return new Body(sheet450_2_impl.getSheet450_2XmlList());
    }
    ...
    public void convertToXml(sheet450_2_Impl sheet450_2_impl, TableImpl table) throws JAXBException, IOException, ClassNotFoundException {
        ...
        String simpleName = "";
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            simpleName = "QDFIR450.2";
        }
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.MONTHLY) == 0) {
            simpleName = this.getClass().getSimpleName();
        }
        marshaller.marshal(new MDFIR450_2(sheet450_2_impl, table), Files.newOutputStream(Paths.get(simpleName + ".xml")));
    }}
