...
@Component
public class MDFIR400_15 {

    public static final String REPORT_NAME = "MDFIR400.15";
    ...
    public MDFIR400_15(sheet400_15_Impl sheet400_15_impl, TableImpl table) {
        this.sheet400_15_impl = sheet400_15_impl;
        this.table = table;
    }
    ...
    public XmlHeader getHEADER() {
        ...
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            table.getTableDataByReportName("QDFIR400.15");
        }
    ...
    public Body getBODY() {
        sheet400_15_impl.fetchAllData();
        return new Body(sheet400_15_impl.getSheet400_15XmlList());
    }
    ...
    public void convertToXml(sheet400_15_Impl sheet400_15_impl, TableImpl table) throws JAXBException, IOException, ClassNotFoundException {
        ...
        String simpleName = "";
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            simpleName = "QDFIR400.15";
        }
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.MONTHLY) == 0) {
            simpleName = this.getClass().getSimpleName();
        }
        marshaller.marshal(new MDFIR400_15(sheet400_15_impl, table), Files.newOutputStream(Paths.get(simpleName + ".xml")));
    }}
