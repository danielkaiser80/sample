...
@Component
public class MDFIR450_5 {

    public static final String REPORT_NAME = "MDFIR450.5";
    ...
    public MDFIR450_5(sheet450_5_Impl sheet450_5_impl, TableImpl table) {
        this.sheet450_5_impl = sheet450_5_impl;
        this.table = table;
    }
    ...
    public XmlHeader getHEADER() {
        ...
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            table.getTableDataByReportName("QDFIR450.5");
        }
    ...
    public Body getBODY() {
        sheet450_5_impl.fetchAllData();
        return new Body(sheet450_5_impl.getSheet450_5XmlList());
    }
    ...
    public void convertToXml(sheet450_5_Impl sheet450_5_impl, TableImpl table) throws JAXBException, IOException, ClassNotFoundException {
        ...
        String simpleName = "";
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            simpleName = "QDFIR450.5";
        }
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.MONTHLY) == 0) {
            simpleName = this.getClass().getSimpleName();
        }
        marshaller.marshal(new MDFIR450_5(sheet450_5_impl, table), Files.newOutputStream(Paths.get(simpleName + ".xml")));
    }}
