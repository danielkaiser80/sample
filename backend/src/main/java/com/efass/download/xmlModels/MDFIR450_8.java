...
@Component
public class MDFIR450_8 {

    public static final String REPORT_NAME = "MDFIR450.8";
    ...
    public MDFIR450_8(sheet450_8_Impl sheet450_8_impl, TableImpl table) {
        this.sheet450_8_impl = sheet450_8_impl;
        this.table = table;
    }
    ...
    public XmlHeader getHEADER() {
        ...
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            table.getTableDataByReportName("QDFIR450.8");
        }
    ...
    public Body getBODY() {
        sheet450_8_impl.fetchAllData();
        return new Body(sheet450_8_impl.getSheet450_8XmlList());
    }
    ...
    public void convertToXml(sheet450_8_Impl sheet450_8_impl, TableImpl table) throws JAXBException, IOException, ClassNotFoundException {
        ...
        String simpleName = "";
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            simpleName = "QDFIR450.8";
        }
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.MONTHLY) == 0) {
            simpleName = this.getClass().getSimpleName();
        }
        marshaller.marshal(new MDFIR450_8(sheet450_8_impl, table), Files.newOutputStream(Paths.get(simpleName + ".xml")));
    }}
