...
@Component
public class MDFIR400 {

   // public static final String REPORT_NAME = "MDFIR400.1";
    public static final String REPORT_NAME = "MDFIR400";
    ...
    public MDFIR400(sheet400_Impl sheet400_impl, TableImpl table) {
    ...
    public XmlHeader getHEADER() {
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.MONTHLY) == 0) {
            table.getTableDataByReportName("MDFIR400");
        }
    ...
    public void convertToXml(sheet400_Impl sheet400_impl, TableImpl table) throws JAXBException, IOException, ClassNotFoundException {
        ...
        marshaller.marshal(new MDFIR400(sheet400_impl, table), Files.newOutputStream(Paths.get(simpleName + ".xml")));
    }}
