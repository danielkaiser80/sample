...
@Component
public class MDFIR450_7 {

    public static final String REPORT_NAME = "MDFIR450.7";
    ...
    public MDFIR450_7(sheet450_7_Impl sheet450_7_impl, TableImpl table) {
        this.sheet450_7_impl = sheet450_7_impl;
        this.table = table;
    }
    ...
    public XmlHeader getHEADER() {
        ...
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            table.getTableDataByReportName("QDFIR450.7");
        }
    ...
    public Body getBODY() {
        sheet450_7_impl.fetchAllData();
        return new Body(sheet450_7_impl.getSheet450_7XmlList());
    }
    ...
    public void convertToXml(sheet450_7_Impl sheet450_7_impl, TableImpl table) throws JAXBException, IOException, ClassNotFoundException {
        ...
        String simpleName = "";
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            simpleName = "QDFIR450.7";
        }
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.MONTHLY) == 0) {
            simpleName = this.getClass().getSimpleName();
        }
        marshaller.marshal(new MDFIR450_7(sheet450_7_impl, table), Files.newOutputStream(Paths.get(simpleName + ".xml")));
    }}
