...
@Component
public class MDFIR450_12 {

    public static final String REPORT_NAME = "MDFIR450.12";
    ...
    public MDFIR450_12(sheet450_12_Impl sheet450_12_impl, TableImpl table) {
        this.sheet450_12_impl = sheet450_12_impl;
        this.table = table;
    }
    ...
    public XmlHeader getHEADER() {
        ...
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            table.getTableDataByReportName("QDFIR450.12");
        }
    ...
    public Body getBODY() {
        sheet450_12_impl.fetchAllData();
        return new Body(sheet450_12_impl.getSheet450_12XmlList());
    }
    ...
    public void convertToXml(sheet450_12_Impl sheet450_12_impl, TableImpl table) throws JAXBException, IOException, ClassNotFoundException {
        ...
        marshaller.marshal(new MDFIR450_12(sheet450_12_impl, table), Files.newOutputStream(Paths.get(simpleName + ".xml")));
    }}
