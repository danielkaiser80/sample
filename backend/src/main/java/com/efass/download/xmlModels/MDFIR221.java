...
public class MDFIR221 {
    ...
    public MDFIR221(sheet221_Impl sheet221_impl, TableImpl table) {
        this.sheet221_impl = sheet221_impl;
        this.table = table;
    }
    ...
    public XmlHeader getHEADER() {
        ...
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            table.getTableDataByReportName("QDFIR221");
        }
    ...
    public Body getBODY() {
        sheet221_impl.fetchAllData();
        return new Body(sheet221_impl.getSheet221XmlList());
    }
    ...
    public void convertToXml(sheet221_Impl sheet221_impl, TableImpl table) throws JAXBException, IOException, ClassNotFoundException {
        ...
        marshaller.marshal(new MDFIR221(sheet221_impl, table), Files.newOutputStream(Paths.get(simpleName + ".xml")));
