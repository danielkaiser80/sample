...
public class MDFIR300 {
    ...
    public MDFIR300(sheet300_Impl sheet300_impl, TableImpl table) {
        this.sheet300_impl = sheet300_impl;
        this.table = table;
    }
    ...
    public XmlHeader getHEADER() {
        ...
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            table.getTableDataByReportName("QDFIR300");
        }
    ...
    public Body getBODY() {
        sheet300_impl.fetchAllData();
        return new Body(sheet300_impl.getSheet300XmlList());
    }
    ...
    public void convertToXml(sheet300_Impl sheet300_impl, TableImpl table) throws JAXBException, IOException, ClassNotFoundException {
        ...
        marshaller.marshal(new MDFIR300(sheet300_impl, table), Files.newOutputStream(Paths.get(simpleName + ".xml")));
    }}
