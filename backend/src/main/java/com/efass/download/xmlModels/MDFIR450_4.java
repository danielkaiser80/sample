...
@Component
public class MDFIR450_4 {

    public static final String REPORT_NAME = "MDFIR450.4";
    ...
    public MDFIR450_4(sheet450_4_Impl sheet450_4_impl, TableImpl table) {
        this.sheet450_4_impl = sheet450_4_impl;
        this.table = table;
    }
    ...
    public XmlHeader getHEADER() {
        ...
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            table.getTableDataByReportName("QDFIR450.4");
        }
    ...
    public Body getBODY() {
        sheet450_4_impl.fetchAllData();
        return new Body(sheet450_4_impl.getSheet450_4XmlList());
    }
    ...
    public void convertToXml(sheet450_4_Impl sheet450_4_impl, TableImpl table) throws JAXBException, IOException, ClassNotFoundException {
        ...
        String simpleName = "";
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            simpleName = "QDFIR450.4";
        }
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.MONTHLY) == 0) {
            simpleName = this.getClass().getSimpleName();
        }
        marshaller.marshal(new MDFIR450_4(sheet450_4_impl, table), Files.newOutputStream(Paths.get(simpleName + ".xml")));
    }}
