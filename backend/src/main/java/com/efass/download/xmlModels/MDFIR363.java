...
public class MDFIR363 {
    ...
    public MDFIR363(sheet363_Impl sheet363_impl, TableImpl table) {
        this.sheet363_impl = sheet363_impl;
        this.table = table;
    }
    ...
    public XmlHeader getHEADER() {
        ...
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            table.getTableDataByReportName("QDFIR363");
    ...
    public Body getBODY() {
        sheet363_impl.fetchAllData();
        return new Body(sheet363_impl.getSheet363XmlList());
    }
    ...
    public void convertToXml(sheet363_Impl sheet363_impl, TableImpl table) throws JAXBException, IOException, ClassNotFoundException {
        ...
        marshaller.marshal(new MDFIR363(sheet363_impl, table), Files.newOutputStream(Paths.get(simpleName + ".xml")));
    }}
