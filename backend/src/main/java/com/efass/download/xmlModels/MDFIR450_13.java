...
@Component
public class MDFIR450_13 {

    public static final String REPORT_NAME = "MDFIR450.13";
    ...
    public MDFIR450_13(sheet450_13_Impl sheet450_13_impl, TableImpl table) {
        this.sheet450_13_impl = sheet450_13_impl;
        this.table = table;
    }
    ...
    public XmlHeader getHEADER() {
        ...
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            table.getTableDataByReportName("QDFIR450.13");
        }
    ...
    public Body getBODY() {
        sheet450_13_impl.fetchAllData();
        return new Body(sheet450_13_impl.getSheet450_13XmlList());
    }
    ...
    public void convertToXml(sheet450_13_Impl sheet450_13_impl, TableImpl table) throws JAXBException, IOException, ClassNotFoundException {
        ...
        marshaller.marshal(new MDFIR450_13(sheet450_13_impl, table), Files.newOutputStream(Paths.get(simpleName + ".xml")));
    }}
