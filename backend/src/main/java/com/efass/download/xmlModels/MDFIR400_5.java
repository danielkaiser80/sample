...
@Component
public class MDFIR400_5 {

    public static final String REPORT_NAME = "MDFIR400.5";
    ...
    public MDFIR400_5(sheet400_5_Impl sheet400_5_impl, TableImpl table) {
        this.sheet400_5_impl = sheet400_5_impl;
        this.table = table;
    }
    ...
    public XmlHeader getHEADER() {
        ...
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            table.getTableDataByReportName("QDFIR400.5");
        }
    ...
    public Body getBODY() {
        sheet400_5_impl.fetchAllData();
        return new Body(sheet400_5_impl.getSheet400_5XmlList());
    }
    ...
    public void convertToXml(sheet400_5_Impl sheet400_5_impl, TableImpl table) throws JAXBException, IOException, ClassNotFoundException {
        ...
        String simpleName = "";
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            simpleName = "QDFIR400.5";
        }
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.MONTHLY) == 0) {
            simpleName = this.getClass().getSimpleName();
        }
        marshaller.marshal(new MDFIR400_5(sheet400_5_impl, table), Files.newOutputStream(Paths.get(simpleName + ".xml")));
    }}
