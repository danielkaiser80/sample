...
public class MDFIR1200 {
    ...
    public MDFIR1200(sheet1200_Impl sheet1200_impl, TableImpl table) {
        this.sheet1200_impl = sheet1200_impl;
        this.table = table;
    }
    ...
    public XmlHeader getHEADER() {
        ...
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            table.getTableDataByReportName("QDFIR1200");
        }
    ...
    public Body getBODY() {
        sheet1200_impl.fetchAllData();
        return new Body(sheet1200_impl.getSheet1200XmlList());
    }
    ...
    public void convertToXml(sheet1200_Impl sheet1200_impl, TableImpl table) throws JAXBException, IOException, ClassNotFoundException {
        ...
        String simpleName = "";
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            simpleName = "QDFIR1200";
        }
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.MONTHLY) == 0) {
            simpleName = this.getClass().getSimpleName();
        }
        marshaller.marshal(new MDFIR1200(sheet1200_impl, table), Files.newOutputStream(Paths.get(simpleName + ".xml")));
    }
}
