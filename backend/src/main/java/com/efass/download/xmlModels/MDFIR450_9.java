...
@Component
public class MDFIR450_9 {

    public static final String REPORT_NAME = "MDFIR450.9";
    ...
    public MDFIR450_9(sheet450_9_Impl sheet450_9_impl, TableImpl table) {
        this.sheet450_9_impl = sheet450_9_impl;
        this.table = table;
    }
    ...
    public XmlHeader getHEADER() {
        ...
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            table.getTableDataByReportName("QDFIR450.9");
        }
    ...
    public Body getBODY() {
        sheet450_9_impl.fetchAllData();
        return new Body(sheet450_9_impl.getSheet450_9XmlList());
    }
    ...
    public void convertToXml(sheet450_9_Impl sheet450_9_impl, TableImpl table) throws JAXBException, IOException, ClassNotFoundException {
        ...
        String simpleName = "";
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            simpleName = "QDFIR450.9";
        }
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.MONTHLY) == 0) {
            simpleName = this.getClass().getSimpleName();
        }
        marshaller.marshal(new MDFIR450_9(sheet450_9_impl, table), Files.newOutputStream(Paths.get(simpleName + ".xml")));
    }}
