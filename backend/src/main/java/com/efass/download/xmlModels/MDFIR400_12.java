...
@Component
public class MDFIR400_12 {

    public static final String REPORT_NAME = "MDFIR400.12";
    ...
    public MDFIR400_12(sheet400_12_Impl sheet400_12_impl, TableImpl table) {
        this.sheet400_12_impl = sheet400_12_impl;
        this.table = table;
    }
    ...
    public XmlHeader getHEADER() {
        ...
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            table.getTableDataByReportName("QDFIR400.12");
        }
    ...
    public Body getBODY() {
        sheet400_12_impl.fetchAllData();
        return new Body(sheet400_12_impl.getSheet400_12XmlList());
    }
    ...
    public void convertToXml(sheet400_12_Impl sheet400_12_impl, TableImpl table) throws JAXBException, IOException, ClassNotFoundException {
        ...
        marshaller.marshal(new MDFIR400_12(sheet400_12_impl, table), Files.newOutputStream(Paths.get(simpleName + ".xml")));
    }}
