...
@Component
public class MDFIR400_11 {

    public static final String REPORT_NAME = "MDFIR400.11";
    ...
    public MDFIR400_11(sheet400_11_Impl sheet400_11_impl, TableImpl table) {
        this.sheet400_11_impl = sheet400_11_impl;
        this.table = table;
    }
    ...
    public XmlHeader getHEADER() {
        ...
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            table.getTableDataByReportName("QDFIR400.11");
        }
    ...
    public Body getBODY() {
        sheet400_11_impl.fetchAllData();
        return new Body(sheet400_11_impl.getSheet400_11XmlList());
    }
    ...
    public void convertToXml(sheet400_11_Impl sheet400_11_impl, TableImpl table) throws JAXBException, IOException, ClassNotFoundException {
        ...
        marshaller.marshal(new MDFIR400_11(sheet400_11_impl, table), Files.newOutputStream(Paths.get(simpleName + ".xml")));
    }}
