...
@Component
public class MDFIR400_2 {

    public static final String REPORT_NAME = "MDFIR400.2";
    ...
    public MDFIR400_2(sheet400_2_Impl sheet400_2_impl, TableImpl table) {
        this.sheet400_2_impl = sheet400_2_impl;
        this.table = table;
    }
    ...
    public XmlHeader getHEADER() {
        ...
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            table.getTableDataByReportName("QDFIR400.2");
        }
    ...
    public Body getBODY() {
        sheet400_2_impl.fetchAllData();
        return new Body(sheet400_2_impl.getSheet400_2XmlList());
    }
    ...
    public void convertToXml(sheet400_2_Impl sheet400_2_impl, TableImpl table) throws JAXBException, IOException, ClassNotFoundException {
        ...
        String simpleName = "";
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            simpleName = "QDFIR400.2";
        }
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.MONTHLY) == 0) {
            simpleName = this.getClass().getSimpleName();
        }
        marshaller.marshal(new MDFIR400_2(sheet400_2_impl, table), Files.newOutputStream(Paths.get(simpleName + ".xml")));
    }}
