...
@Component
public class MDFIR400_14 {

    public static final String REPORT_NAME = "MDFIR400.14";
    ...
    public MDFIR400_14(sheet400_14_Impl sheet400_14_impl, TableImpl table) {
        this.sheet400_14_impl = sheet400_14_impl;
        this.table = table;
    }
    ...
    public XmlHeader getHEADER() {
        ...
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            table.getTableDataByReportName("QDFIR400.14");
        }
    ...
    public Body getBODY() {
        sheet400_14_impl.fetchAllData();
        return new Body(sheet400_14_impl.getSheet400_14XmlList());
    }
    ...
    public void convertToXml(sheet400_14_Impl sheet400_14_impl, TableImpl table) throws JAXBException, IOException, ClassNotFoundException {
        ...
        String simpleName = "";
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            simpleName = "QDFIR400.14";
        }
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.MONTHLY) == 0) {
            simpleName = this.getClass().getSimpleName();
        }
        marshaller.marshal(new MDFIR400_14(sheet400_14_impl, table), Files.newOutputStream(Paths.get(simpleName + ".xml")));
    }}
