...
public class MDFIR333 {
    ...
    public MDFIR333(sheet333_Impl sheet333_impl, TableImpl table) {
        this.sheet333_impl = sheet333_impl;
        this.table = table;
    }
    ...
    public XmlHeader getHEADER() {
        ...
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            table.getTableDataByReportName("QDFIR333");
        }
    ...
    public Body getBODY() {
        sheet333_impl.fetchAllData();
        return new Body(sheet333_impl.getSheet333XmlList());
    }
    ...
    public void convertToXml(sheet333_Impl sheet333_impl, TableImpl table) throws JAXBException, IOException, ClassNotFoundException {
        ...
        marshaller.marshal(new MDFIR333(sheet333_impl, table), Files.newOutputStream(Paths.get(simpleName + ".xml")));
    }}
