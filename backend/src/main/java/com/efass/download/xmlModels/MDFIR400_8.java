...
@Component
public class MDFIR400_8 {

    public static final String REPORT_NAME = "MDFIR400.8";
    ...
    public MDFIR400_8(sheet400_8_Impl sheet400_8_impl, TableImpl table) {
        this.sheet400_8_impl = sheet400_8_impl;
        this.table = table;
    }
    ...
    public XmlHeader getHEADER() {
        ...
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            table.getTableDataByReportName("QDFIR400.8");
        }
    ...
    public Body getBODY() {
        sheet400_8_impl.fetchAllData();
        return new Body(sheet400_8_impl.getSheet400_8XmlList());
    }
    ...
    public void convertToXml(sheet400_8_Impl sheet400_8_impl, TableImpl table) throws JAXBException, IOException, ClassNotFoundException {
        ...
        String simpleName = "";
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            simpleName = "QDFIR400.8";
        }
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.MONTHLY) == 0) {
            simpleName = this.getClass().getSimpleName();
        }
        marshaller.marshal(new MDFIR400_8(sheet400_8_impl, table), Files.newOutputStream(Paths.get(simpleName + ".xml")));
    }}
