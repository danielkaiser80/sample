...
public class MDFIR372 {
    ...
    public MDFIR372(sheet372_Impl sheet372_impl, TableImpl table) {
        this.sheet372_impl = sheet372_impl;
        this.table = table;
    }
    ...
    public XmlHeader getHEADER() {
        ...
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            table.getTableDataByReportName("QDFIR372");
        }
    ...
    public Body getBODY() {
        sheet372_impl.fetchAllData();
        return new Body(sheet372_impl.getSheet372XmlList());
    }
    ...
    public void convertToXml(sheet372_Impl sheet372_impl, TableImpl table) throws JAXBException, IOException, ClassNotFoundException {
        ...
        marshaller.marshal(new MDFIR372(sheet372_impl, table), Files.newOutputStream(Paths.get(simpleName + ".xml")));
