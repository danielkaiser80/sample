...
@Component
public class MDFIR450_15 {

    public static final String REPORT_NAME = "MDFIR450.15";
    ...
    public MDFIR450_15(sheet450_15_Impl sheet450_15_impl, TableImpl table) {
        this.sheet450_15_impl = sheet450_15_impl;
        this.table = table;
    }
    ...
    public XmlHeader getHEADER() {
        ...
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            table.getTableDataByReportName("QDFIR450.15");
        }
    ...
    public Body getBODY() {
        sheet450_15_impl.fetchAllData();
        return new Body(sheet450_15_impl.getSheet450_15XmlList());
    }
    ...
    public void convertToXml(sheet450_15_Impl sheet450_15_impl, TableImpl table) throws JAXBException, IOException, ClassNotFoundException {
        ...
        String simpleName = "";
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            simpleName = "QDFIR450.15";
        }
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.MONTHLY) == 0) {
            simpleName = this.getClass().getSimpleName();
        }
        marshaller.marshal(new MDFIR450_15(sheet450_15_impl, table), Files.newOutputStream(Paths.get(simpleName + ".xml")));
    }}
