...
public class MDFIR1700 {
    ...
    public MDFIR1700(sheet1700_Impl sheet1700_impl, TableImpl table) {
        this.sheet1700_impl = sheet1700_impl;
        this.table = table;
    }
    ...
    public XmlHeader getHEADER() {
        ...
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            table.getTableDataByReportName("QDFIR1700");
        }
    ...
    public Body getBODY() {
        sheet1700_impl.fetchAllData();
        return new Body(sheet1700_impl.getSheet1700XmlList());
    }
    ...
    public void convertToXml(sheet1700_Impl sheet1700_impl, TableImpl table) throws JAXBException, IOException, ClassNotFoundException {
        ...
        String simpleName = "";
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            simpleName = "QDFIR1700";
        }
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.MONTHLY) == 0) {
            simpleName = this.getClass().getSimpleName();
        }
        marshaller.marshal(new MDFIR1700(sheet1700_impl, table), Files.newOutputStream(Paths.get(simpleName + ".xml")));
    }}
