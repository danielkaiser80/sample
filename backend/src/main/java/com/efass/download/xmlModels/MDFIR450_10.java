...
@Component
public class MDFIR450_10 {

    public static final String REPORT_NAME = "MDFIR450.10";
    ...
    public MDFIR450_10(sheet450_10_Impl sheet450_10_impl, TableImpl table) {
        this.sheet450_10_impl = sheet450_10_impl;
        this.table = table;
    }
    ...
    public XmlHeader getHEADER() {
        ...
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            table.getTableDataByReportName("QDFIR450.10");
        }
    ...
    public Body getBODY() {
        sheet450_10_impl.fetchAllData();
        return new Body(sheet450_10_impl.getSheet450_10XmlList());
    }
    ...
    public void convertToXml(sheet450_10_Impl sheet450_10_impl, TableImpl table) throws JAXBException, IOException, ClassNotFoundException {
        ...
        marshaller.marshal(new MDFIR450_10(sheet450_10_impl, table), Files.newOutputStream(Paths.get(simpleName + ".xml")));
    }}
