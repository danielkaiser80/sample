...
@Component
public class MDFIR450_3 {

    public static final String REPORT_NAME = "MDFIR450.3";
    ...
    public MDFIR450_3(sheet450_3_Impl sheet450_3_impl, TableImpl table) {
        this.sheet450_3_impl = sheet450_3_impl;
        this.table = table;
    }
    ...
    public XmlHeader getHEADER() {
        ...
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            table.getTableDataByReportName("QDFIR450.3");
        }
    ...
    public Body getBODY() {
        sheet450_3_impl.fetchAllData();
        return new Body(sheet450_3_impl.getSheet450_3XmlList());
    }
    ...
    public void convertToXml(sheet450_3_Impl sheet450_3_impl, TableImpl table) throws JAXBException, IOException, ClassNotFoundException {
        ...
        String simpleName = "";
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.QUARTERLY) == 0) {
            simpleName = "QDFIR450.3";
        }
        if (TabController.getReportGroupEnum().compareTo(ReportGroupEnum.MONTHLY) == 0) {
            simpleName = this.getClass().getSimpleName();
        }
        marshaller.marshal(new MDFIR450_3(sheet450_3_impl, table), Files.newOutputStream(Paths.get(simpleName + ".xml")));
    }}
