...
@Entity
@Table(name = "QDFIR1000")
public class sheetQdfir1000DAO implements Serializable {
    ...
    public sheetQdfir1000DAO() {

    }

    public sheetQdfir1000DAO(int id, String code, String description, BigDecimal currenMonth, BigDecimal yearToDate) {
        super();
        this.id = id;
        this.code = code;
