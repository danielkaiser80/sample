...
@Entity
@Table(name = "QDFIR400")
public class sheetQdfir400_DAO {
	 @Id
	    ...
	    //public BigDecimal total_principal_accrued_interest ;
    ...
    //public BigDecimal getTotal_principal_accrued_interest() {
	//	return total_principal_accrued_interest;
	//}

//	public void setTotal_principal_accrued_interest(BigDecimal total_principal_accrued_interest) {
//		this.total_principal_accrued_interest = total_principal_accrued_interest;
//	}
