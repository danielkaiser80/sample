...
@Entity
@Table(name = "QDFIR600")
public class sheetQdfir600DAO  implements Serializable {
    ...
    public sheetQdfir600DAO() {

    }

    public sheetQdfir600DAO(int id, String code, String description, BigDecimal term_loan, BigDecimal over_draft, String others_1,
