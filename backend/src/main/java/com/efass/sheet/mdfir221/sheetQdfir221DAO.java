...
@Entity
@Table(name = "QDFIR221")
public class sheetQdfir221DAO  implements Serializable {
    ...
    public sheetQdfir221DAO() {

    }

    public sheetQdfir221DAO(Integer id, String bankCode, String bankName, String account_number, BigDecimal amount, BigDecimal amount_2, String remarks, String type_of_balance) {
