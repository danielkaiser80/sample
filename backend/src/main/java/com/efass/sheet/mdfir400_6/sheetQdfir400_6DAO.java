...
@Entity
@Table(name = "QDFIR400_6")
public class sheetQdfir400_6DAO {
    @Id
    ...
    public sheetQdfir400_6DAO() {
    }

    public sheetQdfir400_6DAO(Integer id, BigDecimal accrued_interest_payable, BigDecimal amount_invested, BigDecimal impairment, BigDecimal interest_rate, BigDecimal invested_certificate_number, LocalDate effective_date, LocalDate maturity_date, BigDecimal principal_payable, BigDecimal tenor, BigDecimal times_rolled_over, String type, BigDecimal upfront_interest_paid) {
        this.id = id;
