...
@Entity
@Table(name = "QDFIR700")
public class sheetQdfir700DAO implements Serializable {
    ...
    public sheetQdfir700DAO(){}

    public sheetQdfir700DAO(Integer id, String code, String description, BigDecimal outstanding_at_beginning_of_month, BigDecimal outstanding_at_end_of_month, BigDecimal average_opening_and_closing_balance, BigDecimal paid_interest_during_the_month) {
        this.id = id;
        this.code = code;
